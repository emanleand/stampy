            ...
            <?php
                foreach ($users as $key => $value) { ?>                     
                    <tr>
                        ...
                        <th>
                            <th><input type="button" class="edit-user btn info small" id="<?php echo $value['id']?>" value="Edit" /></th>
                        </th>
                        <th>
                            <input type="button" class="delete-user btn alert small" value="delete" onclick="deleteUser(<?php echo $value['id']?>)" />
                        </th>
                    </tr>
            <?php 
            }
